...
var TranscribeSpeech = function (_React$Component) {
  _inherits(TranscribeSpeech, _React$Component);

  function TranscribeSpeech(props) {
    _classCallCheck(this, TranscribeSpeech);

    var _this = _possibleConstructorReturn(this, (TranscribeSpeech.__proto__ || Object.getPrototypeOf(TranscribeSpeech)).call(this, props));
  ...
  _createClass(TranscribeSpeech, [{
    key: 'createRecognition',
    value: function createRecognition(SpeechRecognition) {
      var defaults = {
        continuous: true,
    ...
    key: 'bindResult',
    value: function bindResult(props, event) {
      ...
      props.onResult({ interimTranscript: interimTranscript, finalTranscript: finalTranscript });
    }
  }, {
    key: 'start',
...
TranscribeSpeech.propTypes = {
  style: _propTypes2.default.object,
  className: _propTypes2.default.string
};
TranscribeSpeech.defaultProps = {
  style: {},
  className: ''
};
exports.default = TranscribeSpeech;
